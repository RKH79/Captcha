...
$captcha_text_color = imagecolorallocate($target_layer, $red-120, $green-120, $blue-120);
imagettftext($target_layer, 18, 0, 15, 30, $captcha_text_color, __DIR__ . '/123.ttf', $captcha_code);
